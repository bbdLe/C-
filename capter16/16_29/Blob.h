...
template <typename T> template <typename C> Blob<T>::Blob(C beg, C end) : data(new std::vector<T>(beg, end)) {}

template <typename T> Blob<T>::Blob(std::initializer_list<T> li) : data(new std::vector<T>(li)) {}
